...
title-slide-attributes:
  data-background-image: "images/infosession_QRcode.png"
  data-background-size: "25%, contain"
  data-background-opacity: "1.0"
  data-background-position: "75%"
---
...
::: {.column width="75%"}
**[Dr. Andrew O'Geen]{style="color:#d42121;"}**
...
::: {.column width="75%"}
**[Dr. Laurie Heyer]{style="color:#d42121;"}**
...
::: {.column width="75%"}
**[Dr. Kevin Wang]{style="color:#d42121;"}**
...
::: {.column width="75%"}
**[Prof. Pete Benbow '07]{style="color:#d42121;"}**
...
::: {.column width="75%"}
**[Amber MacIntyre]{style="color:#d42121;"}**
...
A highly interdisciplinary field that blends **[mathematics]{style="color:#d42121;"}** with **[computer science]{style="color:#d42121;"}** to extract useful knowledge from data.
...
- Data Science is currently a **[student-designed major]{style="color:#d42121;"}** via the Center for Interdisciplinary Studies (CIS)
